...
python ${SCRIPT_DIR}/main_runner_2.py --base_config ${CONFIG_DIR}/simple_noisy_config_2.yaml --method_configs ${CONFIG_DIR}/cgd_config.yaml --commands_file commands_cgd.txt
